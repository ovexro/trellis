      ...
      {adding && (
        <div className="mb-3 p-3 bg-zinc-800/50 rounded-lg space-y-2">
          <input
            ...
            placeholder="Alert name (e.g., High temperature)"
          ...
          <div className="flex gap-2">
            <select
              ...
              className="flex-1 bg-zinc-900 border border-zinc-700 rounded px-2 py-1.5 text-xs text-zinc-300"
            >
              {sensorIds.map((s) => (
            ...
            <select
              ...
              className="w-20 bg-zinc-900 border border-zinc-700 rounded px-2 py-1.5 text-xs text-zinc-300"
            >
          ...
          <div className="flex gap-2">
            <button onClick={createAlert} className="px-3 py-1 bg-trellis-500 text-white rounded text-xs">
              Create
            </button>
            <button onClick={() => setAdding(false)} className="px-3 py-1 text-zinc-500 text-xs">
              Cancel
            </button>
          </div>
        </div>
